...
## path root folder
ROOT = 'test_detections'
# make two directories inside the above folder with names "images" and "labels" and paste the images with
# detection bounding boxes and text files annotations in them respectively
